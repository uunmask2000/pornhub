...
class Downloader(object):
    ...
    def __init__(self, url, file_name, chunk_count, high_speed=False, headers=None, proxies=None):
        self.url = url
    ...
    def wait_for_finish(self):
        if self.__async:
            ...
            warnings.warn(
                'Downloader was set to run as synchronous. This function will not work')
    ...
    def run(self):
        ...
        if self.chunk_count == 0:
            ...
            new_chunk = Chunk(self, self.url, file=chunk_file,
                              high_speed=self.high_speed, headers=self.headers)
